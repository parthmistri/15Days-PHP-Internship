...
?>
<div id="sidebar">
<h3>Registration For Inquiry</h3><br>
<form class="formgroup" method="post">
		<table align="center">
	 	...
	 	<tr>
	 		<td>Address :</td>
	 		<td><textarea class="form-control " rows= "2" cols="22" name="txt6" ></textarea></td>
	 	</tr>
	 	<tr>
	 		<td>Password :</td>
		...
		<tr>
	 	...
	 	<tr><td><input class="form-control"  type="submit" name="Submit"></td></tr>
